...
def run_sequence1(controller, robot1, scene):
    ...
    controller.move_rmrc(robot1, target_grasp_pose, 50)
    ...
    controller.move_rmrc(robot1, lift_pose, 50)
    ...
    controller.move_rmrc(robot1, r1_target, 50)
...
def run_sequence2(controller, robot2, scene):
    ...
    controller.move_rmrc(robot2, target_r2_pose, 50)
    ...
    controller.move_rmrc(robot2, retract_pose, 50)
    ...
    controller.move_rmrc(robot2, r2_target, 50)
    controller.drop_object(robot2)
...
def run_sequence3(controller, robot3, robot2, scene):
    ...
    controller.move_rmrc(robot3, HOVER_R3, 80)
    ...
    controller.move_rmrc(robot2, HOVER_R2, 80)
    controller.print_pose(robot2, "R2 Retracted")
    ...
    controller.move_rmrc(robot2, r2_target_final, 50)
    controller.drop_object(robot2)
    controller.print_pose(robot2, "R2 after placing glass down")
