...
class IngredientBot(DHRobot3D):
    def __init__(self):
        ...
        link3D_names = dict(
            link0='CRB15000_Joint1', color0=(0.4, 0.45, 0.5, 1),
            link1='CRB15000_Joint2', color1=(0.4, 0.45, 0.5, 1),
            link2='CRB15000_Joint3', color2=(0.4, 0.45, 0.5, 1),
            link3='CRB15000_Joint4', color3=(0.4, 0.45, 0.5, 1),
            link4='CRB15000_Joint5', color4=(0.8, 0.8, 0.8, 1),
            link5='CRB15000_Joint6', color5=(0.8, 0.8, 0.8, 1),
            link6='CRB15000_Joint7', color6=(0.8, 0.8, 0.8, 1),
            link7='CRB15000_Joint7', color7=(0.8, 0.8, 0.8, 1)
        )
        ...
        qtest_transforms = [spb.transl(0, 0, 0) @ spb.rpy2tr(0, 0, -pi/2, order='xyz'),
                            ...
                            spb.transl(0.0139, -0.0001, -0.0007) @ spb.rpy2tr(0, 0, -pi/2, order='xyz'),
                            spb.transl(0.0139, -0.0001, -0.0048) @ spb.rpy2tr(0, 0, -pi/2, order='xyz'),
