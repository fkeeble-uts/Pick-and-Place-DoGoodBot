...
class RobotController:
    ...
    def move_cartesian(self, robot, start_q, target_pose, num_steps, ignore_rotation=False, carry_object=None):
        """
        Generates and follows a Cartesian path, optionally carrying an object.
        """
